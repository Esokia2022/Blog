 ...
 */
function orbisius_ct_wiki_wordpress_child_theme_enqueue_styles() {
    $parent_style = 'orbisius_ct_wiki_wordpress_parent_style';
...
add_action( 'wp_enqueue_scripts', 'orbisius_ct_wiki_wordpress_child_theme_enqueue_styles' );

require ('inc/ajax.php');
require ('inc/enqueue.php');
require ('inc/theme-support.php');
require ('inc/classes/BootstrapBasic4WalkerNavMenu.php');
require ('inc/classes/Bsb4Design.php');
