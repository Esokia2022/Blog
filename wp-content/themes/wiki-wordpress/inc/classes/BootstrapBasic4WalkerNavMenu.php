...
**/
    ...
    class BootstrapBasic4WalkerNavMenu_custom extends \Walker_Nav_Menu
    {
        ...
        public function start_el(&$output, $item, $depth = 0, $args = array(), $id = 0) 
        {
            ...
            if ($depth <= 0) {
                ...
                if (is_object($args) && $args->has_children) {
                    ...
                    //Add attribute on li by ID of menu
                    if($item->ID == 28){
                    $li_attributes .='data-wow-delay="100ms"';
                    }elseif($item->ID == 26){
                    $li_attributes .='data-wow-delay="300ms"';   
                    }elseif($item->ID == 25){
                    $li_attributes .='data-wow-delay="500ms"';
                    }elseif($item->ID == 29){
                    $li_attributes .='data-wow-delay="700ms"';
                    }elseif($item->ID == 27){
                    $li_attributes .='data-wow-delay="900ms"';   
                    } 
                }
            ...
            if (isset($item->classes) && is_array($item->classes) && in_array('dropdown-divider', $item->classes)) {
                ...
                $item_output = "";
                if ($depth > 0) {
                    $item_output = "<div class='dropdown-item-wrapper'>";
                }
                $item_output .= (is_object($args)) ? $args->before : '';
