    ...
    <?php if (have_comments()) { ?> 
        <h2 class="comments-title">
            ...
            if ('1' == $comments_number) {
                ...
                printf(_x('Une réponse à &ldquo;%s&rdquo;', 'comments title', 'bootstrap-basic4'), get_the_title());
            } else {
                printf(
    ...
    comment_form(
        [
            ...
            'comment_field' => '<div class="form-group row">' . 
                            '<label for="comment">' . __('Commentaire', 'bootstrap-basic4') . '</label> ' . 
            ...
            'comment_notes_after' => '<p class="form-text text-muted">' . 
                            ...
                            sprintf(__('Vous pouvez utiliser ces balises et attributs <abbr title="HyperText Markup Language">HTML</abbr> :<br />  %s', 'bootstrap-basic4'), $comment_allowed_tags) . 
                            '</p>'
        ]
    ); 
    endif;
